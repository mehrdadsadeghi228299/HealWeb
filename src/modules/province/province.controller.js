...
const { removePropertInObject } = require("../../common/uitlls/functions");
const getAddressDeatil = require("../../common/uitlls/http");
class PostController {
    ...
    async create (req, res, next) {
        try {
            ...
            const options = removePropertInObject(req.body, ["amount", 'title_post', "description", "lat", "lng", "category", "images"]);
            ...
            const {address, province, city, district} = await getAddressDeatil(lat, lng);
